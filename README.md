...
- One-click penalty removal
- Automatic save file backup before any changes
- Restart & Clear: close game, remove penalty, relaunch in one click
- Auto-detect save file and game executable paths
- Supports 5 languages (EN / ZH-CN / ZH-TW / JA / KO)
...
2. Save file path will be detected automatically
3. Click **Remove Penalty** to reset the Steven flag
4. Or use **Restart & Clear** to close the game, clear the penalty, and relaunch
